...
public class RequestMyRoomsEvent extends IncomingEvent {
    @Override
    public void handle() throws IllegalAccessException, InstantiationException, IOException {

        JSONObject output = new JSONObject();

        Class<? extends OutgoingMessage> classMessage = Emulator.scuti().getOutgoingMessageManager().getMessages().get(Outgoing.MyRoomsMessage);
